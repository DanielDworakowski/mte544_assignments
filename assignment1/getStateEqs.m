function [ measModel, motionModel ] = getStateEqs()
%UNTITLED5 Summary of this function goes here
%   Detailed explanation goes here
syms w1 w2 w3 deltaT theta position
r = 0.25;
l = 0.3;
...
theta_n = theta + w_eq(3)*deltaT;
rotation_m = [cos(theta),-sin(theta),0;sin(theta),cos(theta),0;0,0,(1)];
position_n = position + (rotation_m*v_eq') * deltaT;
...
measModel = linearizedMeas;
motionModel = linearizedMat;
end
